...
@OnlyIn(Dist.CLIENT)
public class JawbreakerspiderModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public JawbreakerspiderModel(ModelPart pRoot) {
        this.root = pRoot;
    ...
    public static LayerDefinition createSpiderBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("body1", CubeListBuilder.create().texOffs(0, 12).addBox(-5.0F, -6.0F, -6.0F, 10.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 15.0F, 9.0F));
