...
public class PanhornRenderer extends GeoEntityRenderer<PanhornEntity> {
    public PanhornRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new PanhornModel());
        this.shadowRadius = 0.5f;
    }

    public PanhornRenderer(EntityRendererProvider.Context renderManager, AnimatedGeoModel<PanhornEntity> modelProvider) {
        super(renderManager, modelProvider);
    }

    @Override
    public ResourceLocation getTextureLocation(PanhornEntity instance) {
        return new ResourceLocation(FightforFeastMod.MOD_ID, "textures/entity/panhorn/panhorn.png");
    }

    @Override
    public RenderType getRenderType(PanhornEntity animatable, float partialTicks, PoseStack stack,
