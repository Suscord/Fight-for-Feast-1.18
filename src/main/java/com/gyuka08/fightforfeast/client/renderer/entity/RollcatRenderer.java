...
public class RollcatRenderer extends GeoEntityRenderer<RollcatEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(RollcatEntity instance) {
        return new ResourceLocation(FightforFeastMod.MOD_ID, "textures/entity/rollcat/rollcat.png");
    }

    @Override
    public RenderType getRenderType(RollcatEntity animatable, float partialTicks, PoseStack stack,
