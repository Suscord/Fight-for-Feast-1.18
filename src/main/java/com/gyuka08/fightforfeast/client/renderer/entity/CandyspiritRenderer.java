...
public class CandyspiritRenderer extends GeoEntityRenderer<CandyspiritEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(CandyspiritEntity instance) {
        return new ResourceLocation(FightforFeastMod.MOD_ID, "textures/entity/candyspirit/candyspirit.png");
    }

    @Override
    public RenderType getRenderType(CandyspiritEntity animatable, float partialTicks, PoseStack stack,
