...
public class TortetoiseRenderer extends GeoEntityRenderer<TortetoiseEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(TortetoiseEntity instance) {
        return new ResourceLocation(FightforFeastMod.MOD_ID, "textures/entity/tortetoise/tortetoise.png");
    }

    @Override
    public RenderType getRenderType(TortetoiseEntity animatable, float partialTicks, PoseStack stack,
