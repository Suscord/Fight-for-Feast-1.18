package com.suscord.fightforfeast.entity.monster;
...
public class Jawbreakerspider extends Spider {
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(net.minecraft.world.entity.monster.Spider.class, EntityDataSerializers.BYTE);
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
        ...
        if (pSpawnData instanceof net.minecraft.world.entity.monster.Spider.SpiderEffectsGroupData) {
            MobEffect mobeffect = ((net.minecraft.world.entity.monster.Spider.SpiderEffectsGroupData)pSpawnData).effect;
            if (mobeffect != null) {
